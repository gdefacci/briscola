declare module Rx {
  ...
  */
    ...
    export interface AnonymousObservableStatic {
       new<T>(obs:(observer: Observer<T>) => IDisposable | Function | void)
    }
  
    export var AnonymousObservable:AnonymousObservableStatic
